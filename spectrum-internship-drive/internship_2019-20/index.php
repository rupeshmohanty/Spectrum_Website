    ...
    <div class="container text-center mt-4">
                <div class="card" style="display:inline-block;width: 45em;">
                    <h1 class="lead pr-auto pl-auto mt-4">
                        Enter your registration no. to get your certificate!
                    </h1>
                    <div class="card-body">
                    <?php
                        if($msg == 'failure') {
                    ...
                    ?>
                        <form action="verify.php" method="POST">
                            ...
                            <button style="border-radius: 25px;background-color: #ff6611 !important;" class="btn btn-primary btn-card">Check status</button>
                        </form>
                    </div>
                </div>
            </div><br>
